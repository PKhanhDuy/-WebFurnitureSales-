    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="f" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <head>
                ...
                <link href="${pageContext.request.contextPath}/public/bootstrap-5.3.3-dist/css/bootstrap.min.css"
                    rel="stylesheet">
                <link rel="stylesheet"
            ...
            <body>
                    ...
                    <header>
                        <div class="header-top-hd">
                            ...
                            <div class="header-icons-hd">
                                ...
                                <h4
                                    style="font-weight: lighter; margin-left: -15px; font-size: large; margin-top: 10px;">
                            ...
                            <div class="col-md-2">
                                <div class="row">
                                    ...
                                    <div class="dropdown-price">
                                        <div id="sort-filter" class="dropdown-toggle-price"
                                            onclick="toggleDropdownPrice()">Tất cả</div>
                                        <div class="dropdown-menu-price">
                                            ...
                                            <div class="dropdown-item-price" onclick="selectItem(this)">Thấp đến cao
                                            </div>
                                            <div class="dropdown-item-price" onclick="selectItem(this)">Cao đến thấp
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="container mt-5">
                            <div id="product-area" class="row">
                                <c:forEach var="p" items="${products}">
                                    <div class="col-md-3">
                                        <div class="card product-card product" data-id="${p.id}"
                                            data-name="${p.proName}" data-img="${p.thumb}" data-price="${p.price}">
                                            ...
                                            <%--
                                                ...
                                                <%-- </li>--%>
                                                    ...
                                                    <c:if test="${currentPage > 1}">
                                                        <li class="page-item">
                                                            <a class="page-link"
                                                                href="list-product?page=${currentPage - 1}">« Trước</a>
                                                        </li>
                                                    </c:if>
                                                    ...
                                                    <c:if test="${currentPage < totalPages}">
                                                        <%-- <a href="products?page=${currentPage + 1}">Tiếp »</a>--%>
                                                            <li class="page-item">
                                                                <a class="page-link"
                                                                    href="list-product?page=${currentPage + 1}"
                                                                    aria-label="Next">
                                                                    ...
                                                                    <div class="cart-see-more-btns">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-5 col-md-5">
                                                                                <div class="use-button fake-btn">
                                                                                    <a
                                                                                        href="product?id=${product.id}&atributeID=${product.atributeID}&cateID=${product.cateID}">--%>
                                                                                        <p>XEM THÊM</p>
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                ...
                <footer class="footer">
                    <div class="footer-container">
                        ...
                        <div class="footer-column">
                            <h3>NEWSLETTER</h3>
                            <p>Hãy để lại email của bạn để nhận được những ý tưởng trang trí mới và thông tin ưu đãi từ
                                KANE'S</p>
